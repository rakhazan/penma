    ...
    return (
        <div className="bg-blurry bg-cover min-h-screen" id="hero">
            ...
            <div className="mx-24 mb-4 gap-2">
                <img src={content.banner} alt={content.name} className="object-cover object-center h-40 w-full rounded-2xl" />
            </div>
            <div className="mx-24 flex">
                ...
                <div className="p-6 bg-slate-200 rounded-2xl basis-5/6 ml-2">
                    <Routes>
                        <Route path="/sttnf/identitas" element={<Identity />} errorElement={<ErrorPage />} />
                        <Route path="/sttnf/organisasi" element={<Organization />} errorElement={<ErrorPage />} />
                        <Route path="/sttnf/profile" element={<Profile />} errorElement={<ErrorPage />} />
                    </Routes>
                </div>
            </div>
        </div>
